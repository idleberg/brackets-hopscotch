...
// Tasks
gulp.task('lint', ['coffeelint', 'csslint', 'jshint', 'jsonlint', 'recess']);
...
gulp.task('recess', function () {
     gulp.src(['./**/*.less', self])
        ...
        .pipe(recess({"noIDs": false, "noOverqualifying": false, "strictPropertyOrder": false} ))
